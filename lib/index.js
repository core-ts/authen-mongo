...
var fields = ['username', 'email', 'displayName', 'gender', 'password', 'disable', 'deactivated', 'suspended', 'lockedUntilTime', 'successTime', 'failTime', 'failCount', 'passwordModifiedTime', 'maxPasswordAge', 'roles', 'userType', 'privileges', 'accessDateFrom', 'accessDateTo', 'accessTimeFrom', 'accessTimeTo', 'language', 'dateFormat', 'timeFormat', 'imageURL'];
...
var MongoUserRepository = /** @class */ (function () {
